...
class HabitCountdown extends StatefulWidget {
  const HabitCountdown({super.key,required this.habit, required  this.onFinish});
  final Habit habit;
...
class _HabitCountdownState extends State<HabitCountdown> {
  ...
  void initState() {
    ...
    vm.startTimer(widget.habit.progress.timeToCompleteHabit!*60,onComplete:widget.onFinish
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      BotonApp(texto: "Cancelar", onPressed: () { Navigator.pop(context); }),
                      BotonApp(texto: "Terminado", onPressed: () {
                        ...
                        Consumer<Countdownvm>(
                          builder: (context, vm, child) {
                            return BotonApp(texto: (vm.paused)?"Pausa":"Continuar", onPressed: () { 
                            vm.pauseTimer();
                          });
                          },
                        ),
